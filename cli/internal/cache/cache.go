...
// replaced inode open keeps reading identical bytes. On Windows a reader's open
// handle can make the rename fail, and the consequence is a re-download next
// run, never a corrupt entry.
