...
// ProfileEntry is one package in a profile and how it tracks versions.
...
// Revision is an immutable published snapshot of a profile; previous
...
// Membership grants a subject a role on a profile.
...
// SyncTarget is a client-side output format a profile is written to.
